...
MIDDLEWARE = [
    ...
    "chatter.common.middleware.turbolinks.TurbolinksMiddleware",
    "chatter.common.middleware.ajax.AjaxRequestFragmentMiddleware",
    ...
    "chatter.common.middleware.http.HttpResponseNotAllowedMiddleware",
]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "libraries": {"pagination": "chatter.common.pagination.templatetags"},
        },
    }
]
